"""
Buy/Sell analysis report — structured output contract (schema v1).

See `schemas/buy_sell_report.json` at the repo root for the frozen JSON Schema (v1.3.0+).
"""
...
class BuySellAiNarratives(BaseModel):
    """
    Supplementary multi-section prose generated by an LLM for education only.
    Deterministic scores and structured fields remain in the main report.
    """

    thesis_expansion: str = ""
    fundamentals_explained: str = ""
    technical_explained: str = ""
    sentiment_explained: str = ""
    final_synthesis_ai: str = ""
    risk_commentary_ai: str = ""
    model_used: str = ""
...
class BuySellReport(BaseModel):
    ...
    ai_narratives: BuySellAiNarratives | None = None
